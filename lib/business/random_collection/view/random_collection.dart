...
class RandomCollection extends StatelessWidget {
  const RandomCollection({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocProvider<RandomCollectionCubit>(
      create: (context) => RandomCollectionCubit(),
      child: const RandomCollectionChild(),
    );
  }
}

class RandomCollectionChild extends StatelessWidget {
  const RandomCollectionChild({super.key});
